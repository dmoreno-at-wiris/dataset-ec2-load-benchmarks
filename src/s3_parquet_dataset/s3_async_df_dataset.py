...
from src.file_loader import S3ParquetLoader
from src.ubiquitous_datasets import UbiquitousDataset


class S3ParquetAsyncDataset(UbiquitousDataset):
    def __init__(
        self,
        s3_bucket_name: str,
    ...
    def load_parquet_dataset(self) -> pl.LazyFrame:
        try:
            df = self.file_loader.load(  # TODO: Consider polars streaming: https://docs.pola.rs/user-guide/concepts/_streaming/ and https://www.rhosignal.com/posts/streaming-in-polars/
